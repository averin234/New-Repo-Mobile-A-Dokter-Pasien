...
import 'package:pluitcare/app/modules/detail-antrian/controllers/detail_antrian_controller.dart';
                  ...
                  child: Column(
                    children: [
                      ...
                      child : Row(
                        ...
                        children: [
                          Text("Tanggal : ",style: GoogleFonts.nunito(
                          fontWeight: FontWeight.bold,
                          color: Colors.black,
                          fontSize: 15),),
                          Text(
                   ...
                   Divider(
                     color: Colors.grey,
                      ...
                      child : Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Dokter : ", style: GoogleFonts.nunito(
                          fontWeight: FontWeight.bold,
                              color: Colors.black,
                              fontSize: 15),),
                          SizedBox(
